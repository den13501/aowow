...
CREATE TABLE `aowow_emotes` (
    ...
    `target_loc4` VARCHAR(95) NULL DEFAULT NULL,
    `target_loc5` VARCHAR(95) NULL DEFAULT NULL,
    ...
    `noTarget_loc4` VARCHAR(85) NULL DEFAULT NULL,
    `noTarget_loc5` VARCHAR(85) NULL DEFAULT NULL,
    ...
    `self_loc4` VARCHAR(85) NULL DEFAULT NULL,
    `self_loc5` VARCHAR(85) NULL DEFAULT NULL,
