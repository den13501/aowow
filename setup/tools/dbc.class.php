...
class DBC
{
    private $_formats = array(                                  // locales block for copy pasta: sxsssssxsxxxxxxxx | xxxxxxxxxxxxxxxxx
        'achievement'                   => 'niiisxsssssxsxxxxxxxxsxsssssxsxxxxxxxxiiiiisxsssssxsxxxxxxxxii',
        'achievement_category'          => 'nisxsssssxsxxxxxxxxx',
        'achievement_criteria'          => 'niiiiiiiisxsssssxsxxxxxxxxiixii',
        'areatable'                     => 'niixixxiiixsxsssssxsxxxxxxxxixxxxxxx',
        ...
        'chartitles'                    => 'nxsxsssssxsxxxxxxxxsxsssssxsxxxxxxxxi',
        'chrclasses'                    => 'nxixsxsssssxsxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxsxixi',
        'chrraces'                      => 'niixxxxixxxsxisxsssssxsxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxi',
        'creaturedisplayinfo'           => 'niiixxssssxxixxx',
        'creaturedisplayinfoextra'      => 'nxxxxxxxxxxxxxxxxxxxs',
        'creaturefamily'                => 'nxxxxixiiisxsssssxsxxxxxxxxs',
        ...
        'dungeonencounter'              => 'niiiisxsssssxsxxxxxxxxx',
        'emotes'                        => 'nxixxxx',
        'emotestext'                    => 'nsiixxxixixxxxxxxxx',
        'emotestextdata'                => 'nsxsssssxsxxxxxxxx',
        'emotestextsound'               => 'niiii',
        'faction'                       => 'niiiiiiiiiiiiiixxxiffixsxsssssxsxxxxxxxxxxxxxxxxxxxxxxxxx',
        ...
        'holidaydescriptions'           => 'nsxsssssxsxxxxxxxx',
        'holidaynames'                  => 'nsxsssssxsxxxxxxxx',
        'itemdisplayinfo'               => 'nssxxsxxxxxiixxxxxxxxxxxx',
        'itemgroupsounds'               => 'niixx',
        'itemextendedcost'              => 'niiiiiiiiiiiiiix',
        'itemlimitcategory'             => 'nsxsssssxsxxxxxxxxii',
        'itemrandomproperties'          => 'nsiiiiisxsssssxsxxxxxxxx',
        'itemrandomsuffix'              => 'nsxsssssxsxxxxxxxxsiiiiiiiiii',
        'itemset'                       => 'nsxsssssxsxxxxxxxxxxxxxxxxxxxxxxxxxiiiiiiiiiiiiiiiiii',
        'itemsubclass'                  => 'iixxxxxxxixxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',
        'lfgdungeons'                   => 'nsxsssssxsxxxxxxxxiiiiiiixiixixixxxxxxxxxxxxxxxxx',
        'lock'                          => 'niiiiixxxiiiiixxxiiiiixxxxxxxxxxx',
        'locktype'                      => 'nsxsssssxsxxxxxxxxsxsssssxsxxxxxxxxsxsssssxsxxxxxxxxs',
        'mailtemplate'                  => 'nsxsssssxsxxxxxxxxsxsssssxsxxxxxxxx',
        'map'                           => 'nsixisxsssssxsxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxiffxixi',
        ...
        'questsort'                     => 'nsxsssssxsxxxxxxxx',
        'questxp'                       => 'niiiiiiiiii',
        'randproppoints'                => 'niiiiiiiiiiiiiii',
        'scalingstatdistribution'       => 'niiiiiiiiiiiiiiiiiiiii',
        'scalingstatvalues'             => 'xniiiiiiiiiiiiiiiiiiiiii',
        'skillline'                     => 'nixsxsssssxsxxxxxxxxsxsssssxsxxxxxxxxixxxxxxxxxxxxxxxxxx',
        'skilllineability'              => 'niiiixxixiiixx',
        'skilllinecategory'             => 'nsxsssssxsxxxxxxxxi',
        'skillraceclassinfo'            => 'niiiiixx',
        'soundambience'                 => 'nii',
        'soundemitters'                 => 'nffxxxxiix',
        'soundentries'                  => 'nisssssssssssxxxxxxxxxxsxixxxx',
        'spell'                         => 'niiiuuuuuuuuixixixixxxxxxxxxiiixxxxiiiiiiiiiiiixxiiiiiiiiiiiiiiiiiiiiiiiiiiiifffiiiiiiiiiiiiiiiiiiiiifffiiiiiiiiiiiiiiifffiiiiiiiiiiiiixsxsssssxsxxxxxxxxsxsssssxsxxxxxxxxsxsssssxsxxxxxxxxsxsssssxsxxxxxxxxiiiiiiiiiixxfffxxxiixiixifffii',
        'spellcasttimes'                => 'nixx',
        'spelldescriptionvariables'     => 'ns',
        'spelldifficulty'               => 'xiiii',
        'spellduration'                 => 'nixx',
        'spellfocusobject'              => 'nsxsssssxsxxxxxxxx',
        'spellicon'                     => 'ns',
        'spellitemenchantment'          => 'niiiiiiixxxiiisxsssssxsxxxxxxxxxxxiiii',
        'spellitemenchantmentcondition' => 'nbbbbbxxxxxbbbbbbbbbbiiiiiXXXXX',
        'spellradius'                   => 'nfxf',
        'spellrange'                    => 'nffffisxsssssxsxxxxxxxxxxxxxxxxxxxxxxxxx',
        'spellrunecost'                 => 'niiii',
        'spellshapeshiftform'           => 'nxsxsssssxsxxxxxxxxiixxiixxiiiiiiii',
        ...
        'talenttab'                     => 'nsxsssssxsxxxxxxxxiiiiis',
        'taxinodes'                     => 'niffxsxsssssxsxxxxxxxxxx',
        'taxipath'                      => 'niix',
        'taxipathnode'                  => 'niiiffxxxxx',
        'totemcategory'                 => 'nsxsssssxsxxxxxxxxiu',
    ...
    private $_fields = array(
        'achievement'                   => 'id,faction,map,previous,name_loc0,name_loc2,name_loc3,name_loc4,name_loc5,name_loc6,name_loc8,description_loc0,description_loc2,description_loc3,description_loc4,description_loc5,description_loc6,description_loc8,category,points,orderInGroup,flags,iconId,reward_loc0,reward_loc2,reward_loc3,reward_loc4,reward_loc5,reward_loc6,reward_loc8,reqCriteriaCount,refAchievement',
        'achievement_category'          => 'id,parentCategory',
        'achievement_criteria'          => 'id,refAchievementId,type,value1,value2,value3,value4,value5,value6,name_loc0,name_loc2,name_loc3,name_loc4,name_loc5,name_loc6,name_loc8,completionFlags,groupFlags,timeLimit,order',
        'areatable'                     => 'id,mapId,areaTable,flags,soundAmbience,zoneMusic,zoneIntroMusic,name_loc0,name_loc2,name_loc3,name_loc4,name_loc5,name_loc6,name_loc8,factionGroupMask',
        ...
        'chartitles'                    => 'id,male_loc0,male_loc2,male_loc3,male_loc4,male_loc5,male_loc6,male_loc8,female_loc0,female_loc2,female_loc3,female_loc4,female_loc5,female_loc6,female_loc8,bitIdx',
        'chrclasses'                    => 'id,powerType,name_loc0,name_loc2,name_loc3,name_loc4,name_loc5,name_loc6,name_loc8,fileString,flags,expansion',
        'chrraces'                      => 'id,flags,factionId,baseLanguage,fileString,side,name_loc0,name_loc2,name_loc3,name_loc4,name_loc5,name_loc6,name_loc8,expansion',
        ...
        'creaturefamily'                => 'id,skillLine1,petFoodMask,petTalentType,categoryEnumID,name_loc0,name_loc2,name_loc3,name_loc4,name_loc5,name_loc6,name_loc8,iconString',
        ...
        'dungeonencounter'              => 'id,map,mode,order,bit,name_loc0,name_loc2,name_loc3,name_loc4,name_loc5,name_loc6,name_loc8',
        ...
        'holidaydescriptions'           => 'id,description_loc0,description_loc2,description_loc3,description_loc4,description_loc5,description_loc6,description_loc8',
        'holidaynames'                  => 'id,name_loc0,name_loc2,name_loc3,name_loc4,name_loc5,name_loc6,name_loc8',
        ...
        'itemlimitcategory'             => 'id,name_loc0,name_loc2,name_loc3,name_loc4,name_loc5,name_loc6,name_loc8,count,isGem',
        'itemrandomproperties'          => 'id,nameINT,enchantId1,enchantId2,enchantId3,enchantId4,enchantId5,name_loc0,name_loc2,name_loc3,name_loc4,name_loc5,name_loc6,name_loc8',
        'itemrandomsuffix'              => 'id,name_loc0,name_loc2,name_loc3,name_loc4,name_loc5,name_loc6,name_loc8,nameINT,enchantId1,enchantId2,enchantId3,enchantId4,enchantId5,allocationPct1,allocationPct2,allocationPct3,allocationPct4,allocationPct5',
        'itemset'                       => 'id,name_loc0,name_loc2,name_loc3,name_loc4,name_loc5,name_loc6,name_loc8,spellId1,spellId2,spellId3,spellId4,spellId5,spellId6,spellId7,spellId8,itemCount1,itemCount2,itemCount3,itemCount4,itemCount5,itemCount6,itemCount7,itemCount8,reqSkillId,reqSkillLevel',
        'itemsubclass'                  => 'class,subClass,weaponSize',
        'lfgdungeons'                   => 'id,name_loc0,name_loc2,name_loc3,name_loc4,name_loc5,name_loc6,name_loc8,levelMin,levelMax,targetLevel,targetLevelMin,targetLevelMax,mapId,difficulty,type,faction,expansion,groupId',
        ...
        'locktype'                      => 'id,name_loc0,name_loc2,name_loc3,name_loc4,name_loc5,name_loc6,name_loc8,state_loc0,state_loc2,state_loc3,state_loc4,state_loc5,state_loc6,state_loc8,process_loc0,process_loc2,process_loc3,process_loc4,process_loc5,process_loc6,process_loc8,strref',
        'mailtemplate'                  => 'id,subject_loc0,subject_loc2,subject_loc3,subject_loc4,subject_loc5,subject_loc6,subject_loc8,text_loc0,text_loc2,text_loc3,text_loc4,text_loc5,text_loc6,text_loc8',
        'map'                           => 'id,nameINT,areaType,isBG,name_loc0,name_loc2,name_loc3,name_loc4,name_loc5,name_loc6,name_loc8,parentMapId,parentX,parentY,expansion,maxPlayers',
        ...
        'questsort'                     => 'id,name_loc0,name_loc2,name_loc3,name_loc4,name_loc5,name_loc6,name_loc8',
        ...
        'skillline'                     => 'id,categoryId,name_loc0,name_loc2,name_loc3,name_loc4,name_loc5,name_loc6,name_loc8,description_loc0,description_loc2,description_loc3,description_loc4,description_loc5,description_loc6,description_loc8,iconId',
        ...
        'skilllinecategory'             => 'id,name_loc0,name_loc2,name_loc3,name_loc4,name_loc5,name_loc6,name_loc8,index',
        ...
        'spellfocusobject'              => 'id,name_loc0,name_loc2,name_loc3,name_loc4,name_loc5,name_loc6,name_loc8',
        'spellicon'                     => 'id,iconPath',
        'spellitemenchantment'          => 'id,charges,type1,type2,type3,amount1,amount2,amount3,object1,object2,object3,name_loc0,name_loc2,name_loc3,name_loc4,name_loc5,name_loc6,name_loc8,conditionId,skillLine,skillLevel,requiredLevel',
        ...
        'spellrange'                    => 'id,rangeMinHostile,rangeMinFriend,rangeMaxHostile,rangeMaxFriend,rangeType,name_loc0,name_loc2,name_loc3,name_loc4,name_loc5,name_loc6,name_loc8',
        'spellrunecost'                 => 'id,costBlood,costUnholy,costFrost,runicPowerGain',
        'spellshapeshiftform'           => 'id,name_loc0,name_loc2,name_loc3,name_loc4,name_loc5,name_loc6,name_loc8,flags,creatureType,displayIdA,displayIdH,spellId1,spellId2,spellId3,spellId4,spellId5,spellId6,spellId7,spellId8',
        ...
        'talenttab'                     => 'id,name_loc0,name_loc2,name_loc3,name_loc4,name_loc5,name_loc6,name_loc8,iconId,raceMask,classMask,creatureFamilyMask,tabNumber,textureFile',
        'taxinodes'                     => 'id,mapId,posX,posY,name_loc0,name_loc2,name_loc3,name_loc4,name_loc5,name_loc6,name_loc8',
        'taxipath'                      => 'id,startNodeId,endNodeId',
        'taxipathnode'                  => 'id,pathId,nodeIdx,mapId,posX,posY',
        'totemcategory'                 => 'id,name_loc0,name_loc2,name_loc3,name_loc4,name_loc5,name_loc6,name_loc8,category,categoryMask',
    ...
    public function __construct($file, $opts = [])
    {
        ...
        $this->file      = $file;
        $this->localized = !!strstr($this->format, 'sxsssssxsxxxxxxxx');
